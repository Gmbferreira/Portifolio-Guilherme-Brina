...
import logo from "../components/ui/icons/fotoPerfil.jpeg";
...
export default function Navbar({
  ...
  return (
    <header
      className={cn(
        "sticky top-0 z-50 w-full border-border/40 bg-background/95 py-2 text-xl backdrop-blur supports-[backdrop-filter]:bg-background/60",
        className,
      )}
    >
